...
My implementation utilizes S2 Cells to classify areas of the Earth, and myt script uses the  [s2sphere Python package](https://s2sphere.readthedocs.io/en/latest/). 
